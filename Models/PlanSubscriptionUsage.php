...
class PlanSubscriptionUsage extends Model
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setTable(config('tenant_subscriptions.tables.plan_subscription_usage'));
        $this->setRules([
            'subscription_id' => 'required|integer|exists:' . config('tenant_subscriptions.tables.plan_subscriptions') . ',id',
            'feature_id' => 'required|integer|exists:' . config('tenant_subscriptions.tables.plan_features') . ',id',
    ...
    {
        return $this->belongsTo(config('tenant_subscriptions.models.plan_feature'), 'feature_id', 'id', 'feature');
    }
    ...
    {
        return $this->belongsTo(config('tenant_subscriptions.models.plan_subscription'), 'subscription_id', 'id', 'subscription');
    }
